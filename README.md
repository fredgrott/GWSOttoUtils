...
Some utility classes for using the otto event bus.
...
```groovy
compile 'com.github.shareme:GWSOttoUtils:{latest-release-number}@aar'
```



Directions in the javdoc how to use, use the source Luke!
...
[Jake Wharton both BusProvider and ScopedBus(modified to ApplicationBus) originals]()
